...
export default class BuyRig extends Shop
{
    constructor(id){
        super(id);
        ...
        this.create_button("10000", "une plateforme");
        ...
        this.$el.on('click', `input[data-id=${id}]`, { class: Rig, that: this, id: id }, this.buy_boat);
    }
