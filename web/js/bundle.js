...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _boatShop = __webpack_require__(12);
	...
	var Game = function () {
	    function Game(config) {
	        ...
	        // Launch map
	        this.map = new _map2.default(1000);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _zoneor = __webpack_require__(7);

	var _zoneor2 = _interopRequireDefault(_zoneor);

	var _zoneisles = __webpack_require__(8);

	var _zoneisles2 = _interopRequireDefault(_zoneisles);

	var _water = __webpack_require__(9);

	var _water2 = _interopRequireDefault(_water);

	var _snapsvgCjs = __webpack_require__(10);
	...
	var Map = function () {
	    ...
	    _createClass(Map, [{
	        ...
	        value: function createMap() {
	            var nbIles = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.sizeTotal;
	            var nbOr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.sizeTotal;


	            // données de la carte

	            var paper = Snap(this.sizeMapX, this.sizeMapY);
	            ...
	            function drawWater(Map, i, j) {
	                console.log(Map);
	                Map.zonesWater.push(new _water2.default(j, i, 50, 50));
	                var draw = paper.path("M" + j + "," + i + "  l50,0  0,50  -50,0  0,-50");
	                draw.attr({
	                    fill: "blue"
	                });
	            }
	            ...
	            //générationY
	            for (var i = 0; i <= this.sizeMapY; i += 50) {
	                var presPosX = 0;
	                //générationX
	                for (var j = 0; j <= this.sizeMapX; j += 50) {

	                    var random = this.getRandom(0, 10);
	                    var it = 0;
	                    ...
	                    if (random == 0 || random == 1 || random == 2) {
	                        ...
	                        if (itOr <= nbOr) {
	                            ...
	                            this.zonesGold.push(new _zoneor2.default(j, i, 50, 50));
	                            var drawGold = paper.path("M" + j + "," + i + "  l50,0  0,50  -50,0  0,-50");
	                            drawGold.attr({
	                                fill: "yellow"
	                            });
	                        ...
	                        if (itIles <= nbIles) {
	                            if (j > presPosX + 50) {
	                                ...
	                                this.zonesIsles.push(new _zoneisles2.default(j, i, 50, 50));
	                                var drawIsles = paper.path("M" + j + "," + i + "  l50,0  0,50  -50,0  0,-50");
	                                drawIsles.attr({
	                                    fill: "grey"
	                                });
...
/***/ (function(module, exports) {
	...
	var Goldzone = function Goldzone(positionX, positionY, width, height) {
	    _classCallCheck(this, Goldzone);
...
/***/ (function(module, exports) {
	...
	var zoneISLES = function zoneISLES(positionX, positionY, width, height) {
	    _classCallCheck(this, zoneISLES);
...
/***/ (function(module, exports) {
	...
	var Water = function Water(positionX, positionY, width, height) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	window.eve = __webpack_require__(11)
