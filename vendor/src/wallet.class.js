export default class Wallet
{
    ...
    displayActionList(){
      ...
      setTimeout(function(ctx){$( "#listText" ).append(`<p class="bounceIn">Vous avez actuellement <br> ${ctx.gold} gold<p>`)}, 1800, this);
      setTimeout(function(ctx){
        $( "#listText" ).append(`<p class="bounceIn">Et vous avez actuellement <br> ${ctx.ecu} ecus<p>`)
        $('#listText').scrollTop($('#listText')[0].scrollHeight); //scrolling end of div
      }, 3600, this);
